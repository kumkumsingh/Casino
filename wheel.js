          ...
          if (diff > 0.0001) {
            ...
            if (shape) {
              ...
              if (selectedText.value === "Odd" && parseInt(price) % 2 !== 0) {
                ...
                document.getElementById("amountWon").innerHTML = "You won $"+(parseInt(betValue)*2);
                //alert("Winning Price is $" + parseInt(price) * parseInt(betValue));
              } else if (
                selectedText.value === "Even" &&
                parseInt(price) % 2 === 0
              ) {
                let betValue = document.getElementById("betValue").value;
                document.getElementById("amountWon").innerHTML = "You won $"+(parseInt(betValue)*2);
                ...
                document.getElementById("amountWon").innerHTML = "!!! Sorry you lost !!!";
              }
            }
            finished = true;
            setTimeout(function() {
